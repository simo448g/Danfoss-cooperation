function [F_eta, Fu, F0, b,F_r,RowAn] =lifting_dynamics(Av,Bv,Pup,Pdown,nd,r, Hp,Hc,nu,DeltaZ0,eta_0,RefV2,ny)
...
index=1; 
for i=2*RowAn-ny+1:RowAn-ny:size(F_r,1)%-RowAn%i=RowAn+r+1:RowAn:size(F_eta,1)%-RowAn
